    ...
    return (
        <div>
          <div className='max-w-6xl mx-auto px-4 mb-10'>
            <MobileFilter openFilter={openFilter} setOpenFilter={setOpenFilter} search={search} setSearch={setSearch} brand={brand} setBrand={setBrand} 
                ...
                <div className='flex gap-8'>
                  ...
                  handleCategoryChange={handleCategoryChange} handleBrandChange={handleBrandChange}/>
                  {
                    ...
                    <div className='flex justify-center items-center md:h-[600px] md:w-[900px] mt-10'>
                       <Lottie animationData={notFound} classId="w-[550px]"/>
                    </div>
                    )
                  }
